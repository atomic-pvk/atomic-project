...
)
{
     ...
     */
    if (!skeleton_access(r)) return; /* skeleton_access denied */
 ...
 */
int skeleton_access(struct r *r /* receive packet pointer */
)
{
    /*
 ...
 */
int skeleton_accept(struct p *p /* peer structure pointer */
)
{
    /*
     * A stratum error occurs if (1) the server has never been
